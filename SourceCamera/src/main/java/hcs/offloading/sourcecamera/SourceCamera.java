...
public class SourceCamera implements WebRTCCallback {
    private static final String TAG = SourceCamera.class.getName();
    ...
    void stopSourceCamera() {
        Log.d(TAG, "stopSourceCamera");
        synchronized (this) {
            if (mPeerConnection != null) {
                try {
